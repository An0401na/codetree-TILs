...
//        System.out.println(idx +"번 기사 얻은 데미지 :" + damageCnt);
    ...
    public static void coloring(int idx, int d, int color) {
        // 진짜 이동시 보드 색칠
...
//        System.out.println("-------------print-------------");
    ...
    public static void printKnights() {

        for (int i = 1; i < N+1; i++) {
            System.out.println(i+".  "+ knights[i].toString());
        }
    }


    public static void getTotalDamege() {
        for (int i = 1; i < N+1; i++) {
            if(!knights[i].isDie){
